...
# reading sheet
df=pd.read_csv("Arsenal_2025_26_-_Sample_Stats.csv")
...
plt.title("Arsenal",fontsize=20,fontweight="bold",y=1)
...
plt.xticks(
    ticks=range(5),
    labels=["Raya","Rice","White","Saka","Saliba"]
)
...
plt.xticks(
    ticks=range(5),
    labels=["Gyökeres","Saka","Odegaard","Havertz","Martinelli"]
)
...
plt.xticks(
    ticks=range(5),
    labels=["Merino","Gabriel","Rice","Eze","Odegaard"])
...
plt.title("Playmakers", fontsize=20, fontweight="bold")
...
plt.xticks(
    ticks=range(5),
    labels=["Odegaard","Saka","Havertz","Gyökeres","Martinelli"])
...
df.to_csv("Arsenal_2025_26_-_Sample_Stats.csv",index=False)
