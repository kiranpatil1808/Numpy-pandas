...
# reading sheet
df=pd.read_csv("Manchester_City_2025_26_-_Sample_Stats.csv")
...
plt.title("Man City",fontsize=20,fontweight="bold",y=1)
...
plt.xticks(
     ticks=range(5),
     labels=["Rodri","Ederson","Foden","Haaland","Silva"])
...
plt.xticks(
     ticks=range(5),
     labels=["Haaland","Foden","Alvarez","Rodri","Doku"])
...
plt.xticks(
      ticks=range(5),
      labels=["Haaland","Dias","Rodri","Alvarez","Foden"])
...
plt.xticks(
    ticks=range(5),
    labels=["Haaland","Foden","Alvarez","De_Bruyne","Rodri"])
...
df.to_csv("Manchester_City_2025_26_-_Sample_Stats.csv",index=False)